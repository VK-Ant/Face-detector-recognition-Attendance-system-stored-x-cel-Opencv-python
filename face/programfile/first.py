...
E = face_recognition.load_image_file(r"C:\Users\VK\Desktop\face\images\e.jpg")
cvt1= cv2.cvtColor(E,cv2.COLOR_BGR2RGB)
J_Test = face_recognition.load_image_file(r"C:\Users\VK\Desktop\face\images\e1.jpg")
